...
export default function Footer() {
    return (
        <div className="bg-slate-100 pb-10 bg-color-dark">
            <div className="m-auto p-3 pt-10 w-full xl:w-1200px">
                <Image src="/images/logo-site.svg" alt="logo-site" width={200} height={45} />
                <div className="mt-4 flex flex-col lg:flex-row gap-4 md:gap-7 lg:gap-7 xl:gap-28">
                    <div className="flex flex-col gap-4 md:flex-row md:gap-12 lg:gap-7 xl:gap-28">
                        <div className="flex flex-col gap-2 ml-1">
                            ...
                            <span className="text-13px">Email: hotro@mysport.vn</span>
                    ...
                    <div className="flex flex-col md:flex-row lg:flex-col gap-6 lg:items-center lg:justify-center">
                        <div className="flex gap-4 items-center">
                            <span className="font-semibold">Tải app mysport</span>
                        ...
                        <div className="flex gap-7 items-center">
                            <span className="font-semibold">Kết nối với mysport</span>
