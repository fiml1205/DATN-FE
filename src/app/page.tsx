...
import { SSToken, userInfo } from '@/utilities/functions'
...
export default function Home() {
  ...
  return (
    <>
      <div className="w-full p-3 mx-auto mt-3 mb-5 flex flex-col gap-5 xl:max-w-1200px">
        <div className="w-full">
          <p className="font-semibold text-lg	mb-3">Cơ sở thể thao khu vực Hà Nội</p>
          <div className="flex flex-col items-center justify-between gap-5 md:flex-row">
            <div className="flex flex-col gap-2 rounded-lg overflow-hidden shadow-lg w-full max-w-400px shadow-color-dark">
              ...
              <div className="px-3 py-2 flex flex-col gap-2">
                <p className="font-semibold line-clamp-2 overflow-hidden text-ellipsis">Sân vận động Thúy Lĩnh Sân vận động Thúy Lĩnh Sân vận động Thúy Lĩnh Sân vận động Thúy Lĩnh Sân vận động Thúy Lĩnh</p>
          ...
          <div className="flex justify-center mt-5">
            <Link href='/' className="py-2 px-4 rounded-md bg-white text-default-color border boder-solid border-default-color">Xem tất cả</Link>
          </div>
        </div>
        <div className="w-full">
          <p className="font-semibold text-lg	mb-3">Cơ sở thể thao khu vực Hồ Chí Minh</p>
          <div className="flex flex-col items-center justify-between gap-5 md:flex-row">
            <div className="flex flex-col gap-2 rounded-lg overflow-hidden shadow-lg w-full max-w-400px shadow-color-dark">
              <div>
                <Swiper
        ...
        <div className="w-full">
          <p className="font-semibold text-lg	mb-3">Cơ sở thể thao khu vực Đà Nẵng</p>
          <div className="flex flex-col items-center justify-between gap-5 md:flex-row">
            <div className="flex flex-col gap-2 rounded-lg overflow-hidden shadow-lg w-full max-w-400px shadow-color-dark">
              <div>
                <Swiper
